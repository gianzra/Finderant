...
def data():
    if request.method == 'GET':
        ...
        for image_col in image_cols:
            format_dict[image_col] = path_to_image_html
        return render_template('data2.html', tables=[df.to_html(classes='data', escape=False ,formatters=format_dict)], titles=['Title'])
        ...
        for image_col in image_cols:
            format_dict[image_col] = path_to_image_html
        return render_template('data2.html', tables=[pencarian.to_html(classes='data', escape=False ,formatters=format_dict)], titles=['Title'])
